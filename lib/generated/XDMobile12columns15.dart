...
class XDMobile12columns15 extends StatelessWidget {
  XDMobile12columns15({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(96.0, 0.0, 143.0, 64.0),
                    size: Size(343.0, 335.0),
                    pinTop: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 43.0, 143.0, 21.0),
                          size: Size(143.0, 64.0),
                          pinLeft: true,
                          pinRight: true,
                          pinBottom: true,
                          fixedHeight: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(15.0, 0.0, 125.0, 37.0),
                          size: Size(143.0, 64.0),
                          pinLeft: true,
                          pinRight: true,
                          pinTop: true,
