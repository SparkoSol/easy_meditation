...
import './XDMobile12columns20.dart';
import './XDComponent61.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDMobile12columns17 extends StatelessWidget {
  XDMobile12columns17({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
            ...
            child: PageLink(
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(-1.0, 2.0, 373.0, 51.0),
                      size: Size(371.0, 54.0),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
                      pinBottom: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(143.0, 20.0, 86.0, 19.0),
                      size: Size(371.0, 54.0),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 373.0, 52.0),
                    size: Size(374.0, 52.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(127.0, 17.0, 168.0, 19.0),
                    size: Size(374.0, 52.0),
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(58.0, 14.0, 24.0, 25.0),
                    size: Size(374.0, 52.0),
                    pinLeft: true,
                    pinTop: true,
                    pinBottom: true,
          ...
          Transform.translate(
            offset: Offset(352.0, 644.0),
            child: Container(
              width: 27.2,
              height: 27.2,
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(4.0),
                border: Border.all(width: 2.0, color: const Color(0xfffefefe)),
              ),
            ),
          ),
          // Adobe XD layer: 'Bg' (shape)
          PageLink(
            links: [
              PageLinkInfo(
                ease: Curves.easeIn,
                duration: 0.3,
                pageBuilder: () => XDMobile12columns20(),
              ),
            ],
            child: Container(
              width: 414.0,
