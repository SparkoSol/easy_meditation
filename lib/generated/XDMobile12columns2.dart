...
class XDMobile12columns2 extends StatelessWidget {
  XDMobile12columns2({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: PageLink(
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(-8.0, 3.0, 380.0, 66.0),
                      size: Size(364.0, 69.0),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
                      pinBottom: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(122.0, 22.0, 122.0, 27.0),
                      size: Size(364.0, 69.0),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 472.0, 450.0),
                    size: Size(472.0, 450.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(55.0, 0.0, 417.0, 417.0),
                          size: Size(472.0, 450.0),
                          pinLeft: true,
                          pinRight: true,
                          pinTop: true,
                          pinBottom: true,
                          child:
                              // Adobe XD layer: '2YEM82cTfO' (shape)
                              Container(
                            decoration: BoxDecoration(
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 147.0, 303.0, 303.0),
                          size: Size(472.0, 450.0),
                          pinLeft: true,
                          pinBottom: true,
                          fixedWidth: true,
                          ...
                          child: Stack(
                            children: <Widget>[
                              Pinned.fromSize(
                                bounds: Rect.fromLTWH(0.0, 0.0, 303.0, 303.0),
                                size: Size(303.0, 303.0),
                                pinLeft: true,
                                pinRight: true,
                                pinTop: true,
                                pinBottom: true,
                                child:
                                    // Adobe XD layer: '347507-PAXBR7-215-r…' (shape)
                                    Container(
                                  decoration: BoxDecoration(
                                    image: DecorationImage(
                                      image: const AssetImage(''),
