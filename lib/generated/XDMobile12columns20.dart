...
import './XDMobile12columns17.dart';
import 'package:adobe_xd/page_link.dart';
import './XDUserinput.dart';
import './XDMobile12columns57.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDMobile12columns20 extends StatelessWidget {
  XDMobile12columns20({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(22.0, 598.0),
            child: PageLink(
              links: [
                PageLinkInfo(
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => XDMobile12columns17(),
                ),
              ],
              child: SizedBox(
                width: 370.0,
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(-5.0, 3.0, 380.0, 56.0),
                      size: Size(370.0, 59.0),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
                      pinBottom: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(141.0, 16.0, 88.0, 27.0),
                      size: Size(370.0, 59.0),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => XDMobile12columns57(),
                ),
              ],
              child: Text(
