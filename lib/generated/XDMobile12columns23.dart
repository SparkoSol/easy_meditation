...
class XDMobile12columns23 extends StatelessWidget {
  XDMobile12columns23({
    Key key,
  }) : super(key: key);
  @override
        ...
        children: <Widget>[
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(26.8, 179.5, 379.0, 480.5),
                    size: Size(428.8, 660.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                    ...
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 32.0, 379.0, 448.5),
                          size: Size(379.0, 480.5),
                          pinLeft: true,
                          pinRight: true,
                          fixedHeight: true,
                          child: Stack(
                            children: <Widget>[
                              Pinned.fromSize(
                                bounds: Rect.fromLTWH(0.0, 393.0, 377.0, 55.5),
                                size: Size(379.0, 448.5),
                                pinBottom: true,
                                fixedWidth: true,
                                fixedHeight: true,
                                child: XDComponent2(),
                              ...
                              Pinned.fromSize(
                                bounds: Rect.fromLTWH(0.0, 327.5, 378.0, 55.5),
                                size: Size(379.0, 448.5),
                                pinBottom: true,
                                fixedWidth: true,
                                fixedHeight: true,
                              ...
                              Pinned.fromSize(
                                bounds: Rect.fromLTWH(0.0, 262.0, 379.0, 55.5),
                                size: Size(379.0, 448.5),
                                fixedWidth: true,
                                fixedHeight: true,
                                child: XDComponent2(),
          ...
          PageLink(
            ...
            child: Container(
              ...
              height: 890.0,
              decoration: BoxDecoration(
                color: const Color(0x69333242),
              ),
            ),
          ),
          Transform.translate(
            offset: Offset(5.0, 254.0),
            child: SizedBox(
              width: 399.0,
              height: 368.0,
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(12.0, 0.0, 387.0, 368.0),
                    size: Size(399.0, 368.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 277.0, 372.0, 51.0),
                    size: Size(399.0, 368.0),
                    pinBottom: true,
                    fixedWidth: true,
                    fixedHeight: true,
