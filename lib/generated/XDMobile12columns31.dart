...
class XDMobile12columns31 extends StatelessWidget {
  XDMobile12columns31({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(-8.0, 3.0, 380.0, 56.0),
                    size: Size(364.0, 59.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(121.0, 16.0, 122.0, 27.0),
                    size: Size(364.0, 59.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(77.0, 0.0, 60.0, 60.0),
                    size: Size(137.0, 60.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Stack(
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(18.0, 16.0, 24.0, 25.0),
                          size: Size(60.0, 60.0),
                          pinLeft: true,
                          pinRight: true,
                          pinTop: true,
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 136.0, 375.0, 52.0),
                    size: Size(375.0, 188.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 3.5, 178.0, 19.0),
                    size: Size(344.2, 27.2),
                    pinLeft: true,
                    pinTop: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(317.0, 0.0, 27.2, 27.2),
                    size: Size(344.2, 27.2),
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            width: 2.0, color: const Color(0xfffefefe)),
                      ),
                    ),
                  ),
                ],
