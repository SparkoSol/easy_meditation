...
import './XDMobile12columns36.dart';
import 'package:adobe_xd/page_link.dart';
import './XDMobile12columns38.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDMobile12columns37 extends StatelessWidget {
  XDMobile12columns37({
    Key key,
  }) : super(key: key);
  @override
                ...
                Pinned.fromSize(
                  ...
                  child:
                    ...
                    children: <Widget>[
                      ...
                      Pinned.fromSize(
                        bounds: Rect.fromLTWH(-15.0, 0.0, 0.0, 0.0),
                        size: Size(414.0, 342.0),
                        pinLeft: true,
                        pinTop: true,
                        fixedWidth: true,
                ...
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    ...
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 224.0, 370.8, 205.0),
                          ...
                          child: Stack(
                            children: <Widget>[
                              Pinned.fromSize(
                                bounds: Rect.fromLTWH(1.5, 164.0, 369.3, 41.0),
                                size: Size(370.8, 205.0),
                                pinBottom: true,
                                fixedWidth: true,
                                fixedHeight: true,
                                child: Stack(
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ease: Curves.easeIn,
                  duration: 0.3,
                  pageBuilder: () => XDMobile12columns36(),
                ),
              ],
              child: Container(
                width: 414.0,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(12.0, 0.0, 380.0, 368.0),
                    size: Size(392.0, 368.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 0.0, 380.0, 368.0),
                          size: Size(380.0, 368.0),
                          pinLeft: true,
                          pinRight: true,
                          pinTop: true,
                          pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(15.0, 0.0, 375.0, 368.0),
                    size: Size(392.0, 368.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(31.0, 0.0, 343.0, 368.0),
                    size: Size(392.0, 368.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(63.0, 33.0, 269.0, 233.0),
                    size: Size(392.0, 368.0),
                    pinTop: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 49.0, 269.0, 184.0),
                          size: Size(269.0, 233.0),
                          pinTop: true,
                          pinBottom: true,
                          fixedWidth: true,
                          child: Stack(
                            children: <Widget>[
                              Pinned.fromSize(
                                bounds: Rect.fromLTWH(212.0, 0.0, 57.0, 184.0),
                                ...
                                child: Stack(
                                  children: <Widget>[
                                    ...
                                    Pinned.fromSize(
                                      bounds:
                                          Rect.fromLTWH(0.0, 56.0, 57.0, 70.0),
                                      size: Size(57.0, 184.0),
                                      pinLeft: true,
                                      pinRight: true,
                                      fixedHeight: true,
                              ...
                              Pinned.fromSize(
                                bounds: Rect.fromLTWH(106.0, 0.0, 57.0, 184.0),
                                size: Size(269.0, 184.0),
                                fixedWidth: true,
                                fixedHeight: true,
                                child: Stack(
                              ...
                              Pinned.fromSize(
                                bounds: Rect.fromLTWH(0.0, 76.0, 56.0, 95.0),
                                size: Size(269.0, 184.0),
                                pinLeft: true,
                                pinBottom: true,
                                fixedWidth: true,
                                ...
                                child: Stack(
                                  children: <Widget>[
                                    ...
                                    Pinned.fromSize(
                                      bounds:
                                          Rect.fromLTWH(0.0, 0.0, 56.0, 47.0),
                                      size: Size(56.0, 95.0),
                                      pinLeft: true,
                                      pinRight: true,
                                      pinTop: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(75.0, 0.0, 114.0, 30.0),
                          size: Size(269.0, 233.0),
                          pinTop: true,
                          fixedWidth: true,
                          fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 281.0, 372.0, 51.0),
                    size: Size(392.0, 368.0),
                    pinBottom: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(229.0, 0.0, 143.0, 51.0),
                          size: Size(372.0, 51.0),
                          pinRight: true,
                          pinTop: true,
                          pinBottom: true,
                          fixedWidth: true,
                          child: PageLink(
                            links: [
                              PageLinkInfo(
                                ease: Curves.easeIn,
                                duration: 0.3,
                                pageBuilder: () => XDMobile12columns38(),
                              ),
                            ],
                            child: Stack(
                              children: <Widget>[
