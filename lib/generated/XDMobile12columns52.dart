...
class XDMobile12columns52 extends StatelessWidget {
  XDMobile12columns52({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 420.0, 342.0),
                    size: Size(420.0, 342.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                    child:
                      ...
                      children: <Widget>[
                        Pinned.fromSize(
                          ...
                          child:
                            ...
                            children: <Widget>[
                              ...
                              Pinned.fromSize(
                                bounds: Rect.fromLTWH(3.0, 210.0, 414.0, 132.0),
                                size: Size(420.0, 342.0),
                                pinLeft: true,
                                pinRight: true,
                                pinBottom: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(25.0, 60.0, 281.0, 83.0),
                          size: Size(420.0, 342.0),
                          pinLeft: true,
                          fixedWidth: true,
                          fixedHeight: true,
                          child:
                            ...
                            children: <Widget>[
                              Pinned.fromSize(
                                bounds: Rect.fromLTWH(0.0, 0.0, 281.0, 83.0),
                                size: Size(281.0, 83.0),
                                pinTop: true,
                                pinBottom: true,
                                fixedWidth: true,
                                child:
                                  ...
                                  children: <Widget>[
                                    Pinned.fromSize(
                                      bounds:
                                          Rect.fromLTWH(91.0, 0.0, 190.0, 68.0),
                                      size: Size(281.0, 83.0),
                                      pinRight: true,
                                      pinTop: true,
                                      fixedWidth: true,
                                    ...
                                    Pinned.fromSize(
                                      bounds:
                                          Rect.fromLTWH(0.0, 4.0, 78.0, 79.0),
                                      size: Size(281.0, 83.0),
                                      pinLeft: true,
                                      pinTop: true,
                                      pinBottom: true,
                  ...
                  Pinned.fromSize(
                    ...
                    child: Stack(
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(29.8, 0.0, 161.0, 32.0),
                          size: Size(428.8, 480.0),
                          pinLeft: true,
                          pinTop: true,
                          fixedWidth: true,
