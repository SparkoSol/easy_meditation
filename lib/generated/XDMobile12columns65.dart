...
class XDMobile12columns65 extends StatelessWidget {
  XDMobile12columns65({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(-4.0, 3.0, 380.0, 56.0),
                    size: Size(372.0, 59.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(158.0, 16.0, 56.0, 27.0),
                    size: Size(372.0, 59.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 47.0, 21.0),
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(52.0, 0.0, 80.0, 21.0),
                    size: Size(132.0, 21.0),
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
